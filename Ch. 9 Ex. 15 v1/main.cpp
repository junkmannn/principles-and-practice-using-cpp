...
void test_money() {
	...
	cout << to_string(Money(100, 0, Money::DKK), Money::DKK) << '\n';
	cout << to_string(Money(100, 0, Money::USD), Money::USD) << '\n';
	cout << to_string(Money(100, 0, Money::DKK), Money::USD) << '\n';
	cout << to_string(Money(100, 0, Money::USD), Money::DKK) << '\n';
