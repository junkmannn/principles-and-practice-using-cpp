...
Book::Book(string p_isbn, string p_title, string p_author, string p_copyright_date):
	isbn(p_isbn), title(p_title), author(p_author), copyright_date(p_copyright_date) {
